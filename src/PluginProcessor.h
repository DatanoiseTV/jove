                           ...
                           private juce::AudioProcessorValueTreeState::Listener
{
  public:
    ...
    int   getSeqStep(int i) const { return (i >= 0 && i < jove::kNumSeq) ? seqStepUI[(size_t) i].load(std::memory_order_relaxed) : 0; }
  ...
  private:
    ...
    std::array<std::atomic<int>, jove::kNumSeq> seqStepUI {};
