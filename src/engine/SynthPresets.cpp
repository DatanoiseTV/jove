...
void perc_tom(SynthPatch& p)
{
    ...
    p.env[2] = EnvParams{0.001f, 0.05f, 0.0f, 0.035f, 0.0f};
    mod(p, 0, ModSource::EnvAux, ModDest::Pitch, 0.9f);
    mod(p, 1, ModSource::Velocity, ModDest::Amp, 0.3f);
    p.fxDrive = 0.1f; p.driveMode = 0;
    p.fxChorus = 0.0f; p.fxDelay = 0.0f; p.fxReverb = 0.06f; p.fxPhaser = 0.0f;
}
...
void perc_808(SynthPatch& p)
{
    ...
    mod(p, 0, ModSource::EnvAux, ModDest::Pitch, 1.0f);
    mod(p, 1, ModSource::Velocity, ModDest::Amp, 0.3f);
    p.fxDrive = 0.28f; p.driveMode = 1; p.driveTone = -0.2f;
    p.fxChorus = 0.0f; p.fxDelay = 0.0f; p.fxReverb = 0.0f; p.fxPhaser = 0.0f;
}
...
void perc_rim(SynthPatch& p)
{
    ...
    p.env[0] = EnvParams{0.001f, 0.05f, 0.0f, 0.035f, 0.25f};
    p.fxChorus = 0.0f; p.fxDelay = 0.0f; p.fxReverb = 0.03f; p.fxPhaser = 0.0f;
}
void perc_clave(SynthPatch& p)
{
    ...
    p.env[2] = EnvParams{0.001f, 0.012f, 0.0f, 0.01f, 0.0f};
    mod(p, 0, ModSource::EnvAux, ModDest::Pitch, 0.5f);
    p.fxChorus = 0.0f; p.fxDelay = 0.0f; p.fxReverb = 0.03f; p.fxPhaser = 0.0f;
}
...
void perc_zap(SynthPatch& p)
{
    ...
    mod(p, 0, ModSource::EnvAux, ModDest::Pitch, 2.0f);
    p.fxChorus = 0.0f; p.fxDelay = 0.18f; p.delayFeedback = 0.3f;
    p.fxReverb = 0.05f; p.fxPhaser = 0.0f;
}
