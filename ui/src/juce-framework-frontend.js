/* Vendored from JUCE 8 modules/juce_gui_extra/native/javascript/{index,check_native_interop}.js
   IIFE-wrapped so non-module <script> tags expose window.Juce + .backend.
   Regenerate by re-running the Python script in WebEditor build notes. */
(function (global) {
/*
  ==============================================================================
...
global.Juce = {
  getNativeFunction, getSliderState, getToggleState, getComboBoxState,
  getBackendResourceAddress, ControlParameterIndexUpdater,
  get backend () { return global.__JUCE__ && global.__JUCE__.backend; },
};
})(window);
